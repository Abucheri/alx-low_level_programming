...
9. Crackme4
	- Find the password for [crackme4](https://github.com/alx-tools/0x17.c 'github source').
...
11. crackme5
	- Write a keygen for [crackme5](https://github.com/alx-tools/0x17.c 'github source').
