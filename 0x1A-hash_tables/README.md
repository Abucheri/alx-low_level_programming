...
7. $ht['Betty'] = 'Cool'
	- In [PHP](https://www.php.net/manual/en/intro-whatis.php 'docs'), hash tables are ordered. Wait… WAT? How is this even possible?
	- ___Before___ you continue, please take a moment to think about it: how you would implement it if you were asked to during an interview or a job. What data structures would you use? How would it work?
